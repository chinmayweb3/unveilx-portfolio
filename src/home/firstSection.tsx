  ...
  return (
    <section className="w-full bg-black px-[60px] pb-[112px] pt-[84px] msm:px-[6%] msm:py-[4rem] msm:pt-[1rem]">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="mt-[150px] flex items-center justify-between gap-[32px] msm:mt-[60px] msm:flex-col msm:items-start">
          <div>
          ...
          <Translation sideRun="-y" className="flex justify-end gap-[12px] uppercase">
